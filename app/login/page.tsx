      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="glass rounded-3xl p-6">
          ...
          <form onSubmit={submit} className="space-y-3">
            ...
            <a href="/api/auth/google" className="w-full flex items-center justify-center gap-2.5 py-3 rounded-2xl text-sm font-medium text-white/60 hover:text-white transition-colors"
